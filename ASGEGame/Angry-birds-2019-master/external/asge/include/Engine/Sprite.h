	...
	*/
	...
	public:
		...
		*/
		...
		/// These enums provide the index numbers that are used
		/// for manipulating the UV coordinates when mapping
		/// textures to sprites.
